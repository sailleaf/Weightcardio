...
public class ColorArcProgressBar extends View {
    ...
    private String curValuesFormat = "%.0f";
    ...
    private void initCofig(Context context, AttributeSet attrs) {
        ...
        curValuesFormat = a.getString(R.styleable.ColorArcProgressBar_current_value_format);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isNeedContent) {
            canvas.drawText(String.format(curValuesFormat, curValues), centerX, centerY + textSize / 3, vTextPaint);
        }
        if (isNeedUnit) {
    ...
    public void setCurValuesFormat(String curValuesFormat) {
        this.curValuesFormat = curValuesFormat;
    }
